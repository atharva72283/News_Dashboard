...
DEFAULT_PORTFOLIO = [
    ...
    {"name":"Bharti Airtel",       "nse_code":"BHARTIARTL",   "position_crs":0},
    {"name":"SBI",   "nse_code":"SBIN",      "position_crs":0},
]
...
.live-dot { width:8px;height:8px;background:#4caf50;border-radius:50%;display:inline-block;margin-right:6px;animation:pulse 10s infinite; }
