    ...
    for url in aspx_urls:
        try:
            ...
            for a in soup.find_all("a", href=True):
                ...
                if not title or len(title) < 20 or title in seen: continue
...
.ticker-card.up   { border-bottom: 3px solid #4caf50; }
.ticker-card.down { border-bottom: 3px solid #f44336; }
.ticker-card.flat { border-bottom: 3px solid #90a4ae; }
