...
with st.sidebar:
    ...
    # ── Stock News Lookup (Integrated from Code 1) ──
    ...
    if stock_query:
        ...
        # Note: Ensure gn() and fetch_urls_parallel() are defined in your main script
        stock_feeds = [
        ...
        if stock_arts:
            ...
            for art in stock_arts[:12]:
                ...
                # Note: Ensure time_ago() is defined in your main script
                ago  = time_ago(art["dt"])
